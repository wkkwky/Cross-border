...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0 h6">{{ translate('Distribution Configuration')}}</h3>
            </div>
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('affiliate.commission') }}" method="POST">
                    @csrf
                    @php
                    ...
                    {{--<div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="hidden" name="types[]" value="commission_status">
                                <input value="1" name="commission_status" id="commission_status" type="checkbox" @if ($commission_status) checked @endif>
                                <span class="slider round"></span>
                            </label>
                        </div>
                    </div>--}}
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="number" min="0" max="100" step="0.01" name="commission_ratio_level_1" class="form-control" value="{{ get_setting('commission_ratio_level_1') }}">
                        </div>
                        <div class="col-lg-2">
                            %
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="number" min="0" max="100" step="0.01" name="commission_ratio_level_2" class="form-control" value="{{ get_setting('commission_ratio_level_2') }}">
                        </div>
                        <div class="col-lg-2">
                            %
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="number" min="0" max="100" step="0.01" name="commission_ratio_level_3" class="form-control" value="{{ get_setting('commission_ratio_level_3') }}">
                        </div>
                        <div class="col-lg-2">
                            %
                        </div>
