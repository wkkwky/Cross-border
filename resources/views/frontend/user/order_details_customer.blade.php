                        ...
                        <tbody>
                            @foreach ($order->orderDetails as $key => $orderDetail)
                                <tr>
                                    ...
                                    @endif
                                    <td class="text-right">
                                        @if ($orderDetail->delivery_status == 'delivered' || true)
...
.table2  {
  border: 2px solid #FFF;
                     ...
                     <table class="table table2">
                        <tr>
                            <td colspan="2" style="text-align:center; background-color:#e62e04;color:#FFF;;"><b>{{ translate('Express information') }}</b> </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" style="text-align:center;background-color:#e62e04;color:#FFF;"><b>{{ translate('Logistics tracking information') }}</b></td>
