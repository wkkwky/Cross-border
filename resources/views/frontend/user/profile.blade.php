        ...
        <!--------------------------->
            ...
            <div class="card-body">
                <div class="row" id="cash">
                    ...
                    <div class="col-md-9">
                        <label class="aiz-switch aiz-switch-success mb-3">
                            <input value="1" name="cash_on_delivery_status" type="checkbox" @if ($user->cash_on_delivery_status == 1) checked @endif>
                ...
                <div class="row" id="bank">
                    ...
                    <div class="col-md-9">
                        <label class="aiz-switch aiz-switch-success mb-3">
                            <input value="1" name="bank_payment_status" type="checkbox" @if ($user->bank_payment_status == 1) checked @endif>
                            <span class="slider round"></span>
                        </label>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bank_name" value="{{ $user->bank_name }}" id="bank_name" class="form-control mb-3" placeholder="{{ translate('Bank Name')}}">
                        @error('phone')
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bank_acc_no" value="{{ $user->bank_acc_no }}" id="bank_acc_no" class="form-control mb-3" placeholder="{{ translate('Bank Account Number')}}">
                        @error('bank_acc_no')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="number" name="bank_routing_no" value="{{ $user->bank_routing_no }}" id="bank_routing_no" lang="en" class="form-control mb-3" placeholder="{{ translate('Bank Routing Number')}}">
               ...
               <div class="row"  id="usdt">
                    ...
                    <div class="col-md-9">
                        <label class="aiz-switch aiz-switch-success mb-3">
                            <input value="1" name="usdt_payment_status" type="checkbox" @if ($user->usdt_payment_status == 1) checked @endif>
                            <span class="slider round"></span>
                        </label>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="usdt_type" value="{{ $user->usdt_type }}" id="usdt_type" class="form-control mb-3" placeholder="{{ translate('USDT Link')}}">
                    </div>
                </div>
                <div class="row">
                    <label class="col-md-3 col-form-label" for="usdt_address">{{ translate('USDT Address') }}</label>
                    <div class="col-md-9">
                        <input type="text" name="usdt_address" value="{{ $user->usdt_address }}" id="usdt_address" class="form-control mb-3" placeholder="{{ translate('USDT Address')}}">
                        @error('usdt_address')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
