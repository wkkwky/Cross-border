                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                ...
                                @if ($detailedProduct->user->shop->online_ervice)
                                    <a target="_blank" href="{{$detailedProduct->user->shop->online_ervice}}"  class="col-auto">
                                        <button class="btn btn-sm btn-soft-primary" >{{ translate('Online Service') }}</button>
                                    </a>
                                @endif
