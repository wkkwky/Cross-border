...
@section('panel_content')
    ...
    <form action="{{ route('seller.shop.online_service_update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{ translate('Change Online Service')}}</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-2">
                        <label>{{ translate('customer service link') }}</label>
                    </div>
                    <div class="col-md-10">
                        <div class="input-group mb-3">
                            <input type="text" name="online_ervice" value="{{ $shop->online_ervice }}" class="form-control mb-3" placeholder="{{ translate('Online Service')}}">
                        </div>
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
                        </div>
