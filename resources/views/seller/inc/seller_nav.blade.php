        ...
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            ...
            @if ($customer_service_link)
                <div class="d-flex justify-content-around align-items-center align-items-stretch ml-3" style="width: auto">
                    <div class="aiz-topbar-item">
                        <div class="d-flex align-items-center">
                        <span onclick="Jump()" class="btn btn-circle btn-light customer_service_link" title="{{ translate('Customer service link') }}">
                            {{ translate('Customer service link')}}
                        </span>
                        </div>
                    </div>
                </div>
                        ...
                        @foreach (\App\Models\Language::all() as $key => $language)
                            <li>
                                <a href="javascript:void(0)" data-flag="{{ $language->code }}" class="dropdown-item @if($locale == $language->code) active @endif">
                                    ...
                                    <span class="language">{{ $language->name }}</span> </a>
                            </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="align-items-stretch d-flex dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-md">
                        <a href="{{ route('seller.profile.index') }}" class="dropdown-item">
                            <i class="las la-user-circle"></i> <span>{{translate('Profile')}}</span> </a>

                        <a href="{{ route('logout')}}" class="dropdown-item"> <i class="las la-sign-out-alt"></i>
