                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-raw fs-15 mb-5">
                                ...
                                <li class="list-group-item py-2">
                                    <i class="las la-check text-success mr-2"></i>
                                    {{translate('Max profit')}} {{ $seller_package->max_profit }}%
                                </li>
                            </ul>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h5 class="text-center">{{ translate('Pay with wallet')}}
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $('#payment_button').on('click', function () {
            ...
            $.post('{{route('orders.buy_package_cash')}}', {
                _token: '{{ csrf_token() }}',
        ...
        function payment_type(type){
            ...
            if(type == 'online'){
                ...
                $("#select_type_cancel").click();
                $.post('{{ route('seller.offline_seller_package_purchase_modal') }}', {_token:'{{ csrf_token() }}', package_id:package_id}, function(data){
