            ...
            <form class="p-4" action="{{ route('seller_packages.update', $seller_package->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group col-sm-10">
                        <input type="number" min="0" step="1" placeholder="{{translate('Max profit')}}" value="{{ $seller_package->getTranslation('max_profit', $lang) }}" id="max_profit" name="max_profit" class="form-control" required>
