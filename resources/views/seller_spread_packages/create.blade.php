...
@section('content')
    ...
    <div class="col-lg-10 mx-auto">
        <div class="card">
            ...
            <form class="form-horizontal" action="{{ route('seller_spread_packages.store') }}" method="POST" enctype="multipart/form-data">
            	@csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="input-group col-sm-10">
                            <input type="number" min="0" step="1" placeholder="{{translate('Max profit')}}" value="" id="max_profit" name="max_profit" class="form-control" required>
