                        ...
                        @if ($user && $user->shop)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="{{route('salesman.sellers.payment_histories', encrypt($seller_withdraw_request->user_id))}}" class="btn btn-soft-primary btn-icon btn-circle btn-sm"  title="{{ translate('Payment History') }}">
...
@section('script')
  <script type="text/javascript">
      ...
      function show_message_modal(id){
          $.post('{{ route('salesman.withdraw_request.message_modal') }}',{_token:'{{ @csrf_token() }}', id:id}, function(data){
