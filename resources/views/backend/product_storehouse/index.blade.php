...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="h3">{{translate('Product Storehouse')}}</h1>
        </div>
        @if($type != 'Seller')
...
<div class="card">
    <form class="" id="sort_products" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-md-0 h6">{{ translate('Product Storehouse') }}</h5>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-alert" data-href="{{route('product-storehouse-move-out', $product->id)}}" data-target="#movie-out-modal" title="{{ translate('Move out') }}">
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title h6">{{translate('Move Out Confirmation')}}</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                </div>
                <div class="modal-body text-center">
                    <p class="mt-1">{{translate('Are you sure to move this out?')}}</p>
                    <button type="button" class="btn btn-link mt-2" data-dismiss="modal">{{translate('Cancel')}}</button>
                    <a href="" id="comfirm-link" class="btn btn-primary mt-2">{{translate('Move Out')}}</a>
                </div>
            </div>
        </div>
    </div>
