        ...
        <table class="table aiz-table mb-0">
            <thead>
                <tr>
                    ...
                    <th data-breakpoints="lg">{{translate('Salesman Status')}}</th>
            ...
            <tbody>
                @foreach($products as $key => $product)
                    <tr>
                        ...
                        <td><a href="{{ route('salesman.product', $product->slug) }}" class="text-reset text-truncate-2" target="_blank">{{$product->getTranslation('name')}}</a></td>
                        ...
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('salesman.product', $product->slug)}}" title="{{ translate('Show') }}">
                                <i class="las la-eye"></i>
                            </a>
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('salesman_products.destroy', $product->id)}}}}" title="{{ translate('Delete') }}">
