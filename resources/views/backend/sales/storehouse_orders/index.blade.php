...
<div class="card">
    <form class="" action="" id="sort_orders" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-md-0 h6">{{ translate('Storehouse Orders') }}</h5>
            </div>
...
<!--                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModal">
            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="md">{{ translate('Storehouse Amount') }}</th>
                        <th data-breakpoints="md">{{ translate('Profit') }}</th>
                        <th data-breakpoints="md">{{ translate('Storehouse Payment Status') }}</th>
                        <th data-breakpoints="md">{{ translate('Pick Up Status') }}</th>
                        <th data-breakpoints="md">{{ translate('Freeze Funds') }}</th>
    ...
    <!--                    <td>
                        ...
                        @endif
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('storehouse_orders.show', encrypt($order->id))}}" title="{{ translate('View') }}">
