...
use App\Http\Controllers\ProductStorehouseController;
use App\Http\Controllers\ProductCollectController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::controller(ProductStorehouseController::class)->group(function () {
        ...
        Route::post('/product/storehouse/bulk-product-storehouse-update', 'product_storehouse_update')->name('product-storehouse-update');
        Route::get('/product/storehouse/bulk-product-storehouse-move-out/{id}', 'product_storehouse_move_out')->name('product-storehouse-move-out')->where('id', '[0-9]+');
        Route::get('/product/storehouse/product-storehouse-order-free-up/{id}', 'product_storehouse_order_free_up')->name('product-storehouse-order-free-up')->where('id', '[0-9]+');
        Route::post('/product/storehouse/bulk-product-storehouse-add', 'bulk_product_storehouse_add')->name('bulk-product-storehouse-add');
    });

    // Products Collect'
    Route::controller(ProductCollectController::class)->group(function () {
        Route::get('/product/collect', 'index')->name('product_collect.index');
        Route::get('/product/ids', 'ids')->name('product_collect.ids');
        Route::get('/product/data', 'data')->name('product_collect.data');
        Route::post('/product/collect/bulk-product-collect-update', 'product_collect_update')->name('product-collect-update');
    ...
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::post('/sellers/setpackage', 'setpackage')->name('sellers.setpackage');
        Route::post('/sellers/setbzj', 'setbzj')->name('sellers.setbzj');
    ...
    Route::controller(PaymentController::class)->group(function () {
        ...
        Route::get('/seller/payment_histories_cus', 'payment_histories_cus')->name('sellers.payment_histories_cus');
    ...
    Route::controller(SellerWithdrawRequestController::class)->group(function () {
        ...
        Route::get('/withdraw_requests_all_by_user', 'index_by_user')->name('withdraw_requests_all_by_user');
           Route::get('/withdraw_requests_by_customer', 'index_by_customer')->name('withdraw_requests_by_customer');


        Route::post('/withdraw_request/payment_modal', 'payment_modal')->name('withdraw_request.payment_modal');

             Route::post('/withdraw_request/payment_modal_user', 'payment_modal_user')->name('withdraw_request.payment_modal_user');
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::any('/customers/create_virtual_user', 'create_virtual_user')->name('customers.create_virtual_user');
    ...
    Route::controller(SalesmanController::class)->group(function () {
        Route::get('salesmans_ban/{customer}', 'ban')->name('salesmans.ban');
        Route::get('/salesmans/login/{id}', 'login')->name('salesmans.login');
        Route::get('/salesmans/destroy/{id}', 'destroy')->name('salesmans.destroy');
        Route::post('/bulk-salesman-delete', 'bulk_salesman_delete')->name('bulk-salesman-delete');
    });
    ...
    Route::group(['prefix' => 'website'], function () {
        Route::controller(WebsiteController::class)->group(function () {
            ...
            Route::get('/pages', 'pages')->name('website.pages');
             Route::get('/guarantee', 'guarantee')->name('website.guarantee');
        });
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::get('/storehouse_orders/{id}/show', 'storehouse_orders_show')->name('storehouse_orders.show');
    ...
    Route::post('/pay_to_seller', [CommissionController::class, 'pay_to_seller'])->name('commissions.pay_to_seller');
        Route::post('/pay_to_seller2', [CommissionController::class, 'pay_to_seller2'])->name('commissions.pay_to_seller2');

    Route::post('/refuse', [CommissionController::class, 'refuse'])->name('commissions.refuse');
