...
use App\Http\Controllers\SellerSpreadPackagePaymentController;
...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::get('/offline-wallet-recharge-requests-by-seller', [WalletController::class, 'offline_recharge_request_by_seller'])->name('offline_wallet_recharge_request_by_seller.index');
    ...
    // Seller Spread Package purchase request
    Route::get('/offline-seller-spread-package-payment-requests', [SellerSpreadPackagePaymentController::class, 'offline_payment_request'])->name('offline_seller_spread_package_payment_request.index');
    Route::post('/offline-seller-spread-package-payment/approved', [SellerSpreadPackagePaymentController::class, 'offline_payment_approval'])->name('offline_seller_spread_package_payment.approved');
...
Route::group(['prefix' =>'salesman', 'middleware' => ['auth', 'salesman']], function(){
    Route::resource('salesman.manual_payment_methods', ManualPaymentMethodController::class);
    Route::get('/manual_payment_methods/destroy/{id}', [ManualPaymentMethodController::class, 'destroy'])->name('salesman.manual_payment_methods.destroy');
    Route::get('/offline-wallet-recharge-requests', [WalletController::class, 'offline_recharge_request'])->name('salesman.offline_wallet_recharge_request.index');
    Route::post('/offline-wallet-recharge/approved', [WalletController::class, 'updateApproved'])->name('salesman.offline_recharge_request.approved');

    // Seller Package purchase request
    Route::get('/offline-seller-package-payment-requests', [SellerPackagePaymentController::class, 'offline_payment_request'])->name('salesman.offline_seller_package_payment_request.index');
    Route::post('/offline-seller-package-payment/approved', [SellerPackagePaymentController::class, 'offline_payment_approval'])->name('salesman.offline_seller_package_payment.approved');

    // customer package purchase request
    Route::get('/offline-customer-package-payment-requests', [CustomerPackagePaymentController::class, 'offline_payment_request'])->name('salesman.offline_customer_package_payment_request.index');
    Route::post('/offline-customer-package-payment/approved', [CustomerPackagePaymentController::class, 'offline_payment_approval'])->name('salesman.offline_customer_package_payment.approved');
});
...
Route::group(['prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user'], 'as' => 'seller.'], function () {
    ...
    // Seller Spread Package purchase
    Route::post('/offline-seller-spread-package-purchase-modal', [ManualPaymentMethodController::class, 'offline_seller_spread_package_purchase_modal'])->name('offline_seller_spread_package_purchase_modal');
    Route::post('/offline-seller-spread-package-paymnet',[SellerSpreadPackageController::class, 'purchase_spread_package_offline'])->name('spread_make_offline_payment');
});
