    ...
    public function getDone(Request $request)
    {
        ...
        try {
            ...
            if($request->session()->has('payment_type')){
                ...
                elseif ($request->session()->get('payment_type') == 'seller_spread_package_payment') {
                    return (new SellerSpreadPackageControlle)->spread_purchase_payment_done($request->session()->get('payment_data'), json_encode($response));
                }
            }
        }catch (\Exception $ex) {
