                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                ...
                                <span class="fs-16 text-info"><?php echo e(translate('Products')); ?></span>
                            </p>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-16 text-info"><?php echo e(translate('Rating')); ?></span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-16 text-info"><?php echo e(translate('Total Order')); ?></span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-16 text-info"><?php echo e(translate('Total Sales')); ?></span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                                <?php
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-16 text-info"><?php echo e(translate('Today Views')); ?></span>
                            </p>
                            <h3 class="mb-0 text-primary fs-30 mt-1">
                                <?php echo e(Auth::user()->shop->views); ?>
...
<?php echo $__env->make('seller.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/kjshop.abczsm.vip/resources/views/seller/dashboard.blade.php ENDPATH**/ ?>