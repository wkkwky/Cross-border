                        ...
                        <?php else: ?>
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = Auth::user()->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <li class="list-group-item">
                                                    <?php if($notification->type == 'App\Notifications\OrderNotification'): ?>
                                                        ...
                                                        <a href="<?php echo e(route('purchase_history.details', encrypt($notification->data['order_id']))); ?>" class="text-reset">
                                                            <span class="ml-2">
                                                        ...
                                                        <?php elseif(Auth::user()->user_type == 'seller'): ?>
                                                            <a href="<?php echo e(route('seller.orders.show', encrypt($notification->data['order_id']))); ?>" class="text-reset">
                                                                <span class="ml-2">
                                                                    <?php echo e(translate('Order code: ')); ?> <?php echo e($notification->data['order_code']); ?> <?php echo e(translate('has been '. ucfirst(str_replace('_', ' ', $notification->data['status'])))); ?>
                            ...
                            <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                                <?php if(Auth::user()->user_type == 'seller'): ?>
                                    <a href="<?php echo e(route('seller.dashboard')); ?>" class="text-reset d-inline-block opacity-60 py-2"><?php echo e(translate('My Panel')); ?></a>
                                <?php else: ?>
...
<?php /**PATH /www/wwwroot/kjshop.abczsm.vip/resources/views/frontend/inc/nav.blade.php ENDPATH**/ ?>