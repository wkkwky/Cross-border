    				...
    				<div class="aiz-file-box">
    					<div class="dropdown-file" >
    						...
    						<div class="dropdown-menu dropdown-menu-right">
    							...
    							<a href="javascript:void(0)" class="dropdown-item confirm-alert" data-href="<?php echo e(route('seller.my_uploads.destroy', $file->id )); ?>" data-target="#delete-modal">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('seller.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/www.bfmma.shop/resources/views/seller/uploads/index.blade.php ENDPATH**/ ?>