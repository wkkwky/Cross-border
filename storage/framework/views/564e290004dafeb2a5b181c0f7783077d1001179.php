        ...
        <!--------------------------->
            ...
            <div class="card-body">
                <div class="row" id="cash">
                    ...
                    <div class="col-md-9">
                        <label class="aiz-switch aiz-switch-success mb-3">
                            <input value="1" name="cash_on_delivery_status" type="checkbox" <?php if($user->cash_on_delivery_status == 1): ?> checked <?php endif; ?>>
                ...
                <div class="row" id="bank">
                    ...
                    <div class="col-md-9">
                        <label class="aiz-switch aiz-switch-success mb-3">
                            <input value="1" name="bank_payment_status" type="checkbox" <?php if($user->bank_payment_status == 1): ?> checked <?php endif; ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bank_name" value="<?php echo e($user->bank_name); ?>" id="bank_name" class="form-control mb-3" placeholder="<?php echo e(translate('Bank Name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bank_acc_name" value="<?php echo e($user->bank_acc_name); ?>" id="bank_acc_name" class="form-control mb-3" placeholder="<?php echo e(translate('Bank Account Name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="bank_acc_no" value="<?php echo e($user->bank_acc_no); ?>" id="bank_acc_no" class="form-control mb-3" placeholder="<?php echo e(translate('Bank Account Number')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="number" name="bank_routing_no" value="<?php echo e($user->bank_routing_no); ?>" id="bank_routing_no" lang="en" class="form-control mb-3" placeholder="<?php echo e(translate('Bank Routing Number')); ?>">
...
unset($__errorArgs, $__bag); ?>
               ...
               <div class="row"  id="usdt">
                    ...
                    <div class="col-md-9">
                        <label class="aiz-switch aiz-switch-success mb-3">
                            <input value="1" name="usdt_payment_status" type="checkbox" <?php if($user->usdt_payment_status == 1): ?> checked <?php endif; ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="usdt_type" value="<?php echo e($user->usdt_type); ?>" id="usdt_type" class="form-control mb-3" placeholder="<?php echo e(translate('USDT Link')); ?>">
                    </div>
                </div>
                <div class="row">
                    <label class="col-md-3 col-form-label" for="usdt_address"><?php echo e(translate('USDT Address')); ?></label>
                    <div class="col-md-9">
                        <input type="text" name="usdt_address" value="<?php echo e($user->usdt_address); ?>" id="usdt_address" class="form-control mb-3" placeholder="<?php echo e(translate('USDT Address')); ?>">
...
<?php echo $__env->make('frontend.layouts.user_panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/kjshop.abczsm.vip/resources/views/frontend/user/profile.blade.php ENDPATH**/ ?>